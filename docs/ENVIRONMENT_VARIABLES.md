...
| `AI_STT_MODEL` | Optional | Worker | `gemini-2.5-flash` | STT model for `/api/voice/transcribe`. |
...
| `ANDROID_KEYSTORE_BASE64` | Android release | GitHub secret | hidden | Android signing keystore as base64. |
| `ANDROID_KEYSTORE_PASSWORD` | Android release | GitHub secret | hidden | Android signing password. |
| `ANDROID_KEY_ALIAS` | Android release | GitHub secret | `xion-assistant` | Android signing alias. |
