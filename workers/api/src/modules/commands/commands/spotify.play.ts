...
export const spotifyPlayCommand: CommandDefinition = {
  name: "spotify.play", description: "Preparar reproduccion en Spotify", examples: ["pon musica", "pon Bad Bunny en Spotify"], patterns: [/\bpon musica\b/, /\breproduce\b.*\bspotify\b/, /\bpon\b.*\ben spotify\b/, /\bplaylist\b/],
