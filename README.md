...
Version `v0.0.1` is a foundation, not the complete final assistant. It implements the first executable slice and documents what remains for OAuth providers, desktop/mobile installers, real TTS/STT providers, R2 uploads, and production deployments.
