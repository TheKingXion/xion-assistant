...
Version `v0.4.0` is a foundation, not the complete final assistant. It implements the first executable slice plus D1-backed persistence, contact routing, a mock/configurable AI Gateway, and a tool registry with risk/confirmation metadata. OAuth providers, desktop/mobile installers, real TTS/STT providers, R2 uploads, and production deployments remain documented next phases.
